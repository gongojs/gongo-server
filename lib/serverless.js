...
class GongoServerless {
  ...
  express() {
    return async (req, res) => {
      ...
      console.log(out);
      /*
      if (out && out.subResults && out.subResults.length) {
        //console.log(out.subResults[3].results[0])
        console.log(out.subResults[3].results[0].entries.slice(0,1))
        console.log(ARSON.encode(out.subResults[3].results[0].entries.slice(0,1)))
      }
      */
